...
const en = {
  ...
  fishing: {
    ...
    nibble: 'Nibble',
    bitePeak: 'Peak {{peak}}°',
    watchingCount: 'Watching {{watching}} of {{total}} rods',
    impactTitle: 'Rod knocked, or a run',
    impactBody: 'Sharp movement with real acceleration. A fish running and someone bumping the rod look the same — check it.',
  ...
  settings: {
    ...
    vibration: 'Vibration',
    sound: 'Sound',
    soundUnavailable: 'No alert sounds ship in this build — alerts vibrate and notify.',
    preview: 'Preview',
  ...
  signal: {
    ...
    diagTooSlow: 'The tag is being heard, but only {{rate}} readings/s — detection needs {{needed}}/s.',
    diagNoMotion: 'The tag is being heard, but it is sending no motion data.',
    diagStalled: 'The tag is being heard, but it has stopped sending readings.',
    diagSilent: 'Nothing is being heard from the tag at all.',
  ...
  chart: {
    ...
    stale: 'No data for {{seconds}}s — this rod is not being watched',
